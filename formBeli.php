...
<html>
<head>
	<title>Demo Cookie Pada PHP | JagoWebDev.com</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<link rel="shortcut icon" href="http://jagowebdev.com/wp-content/demo/includes/assets/img/favicon.png" />
	<style type="text/css">
	body {
...
<div class="container copyright">&copy; <?=date('Y')?> Reiza Erviananda<br/>
